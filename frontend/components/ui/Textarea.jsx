  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      <textarea
        id={inputId}
        ref={ref}
        className={`min-h-[120px] rounded-xl border bg-white px-4 py-3 text-charcoal-900 placeholder:text-warm-400 focus:outline-none focus:ring-2 focus:ring-forest-500/20 focus:border-forest-500 transition-colors resize-y ${
