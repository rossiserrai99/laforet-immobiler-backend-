  ...
  return (
    <div className={`w-full flex flex-col gap-1.5 ${className}`}>
      ...
      <input
        id={inputId}
        ref={ref}
        className={`w-full h-11 sm:h-12 rounded-xl border bg-white px-4 text-charcoal-900 placeholder:text-warm-400 focus:outline-none focus:ring-2 focus:ring-forest-500/20 focus:border-forest-500 transition-colors ${
